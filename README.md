...
We provide the trained models for various 3D medical image analysis tasks, which can be downloaded from [BaiduYun](https://pan.baidu.com/s/1uqlp1tGNcDFIUr3itBmx3A?pwd=RUCS) (verification code: RUCS).
## Deployment
